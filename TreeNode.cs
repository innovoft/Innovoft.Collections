...
namespace Innovoft.Collections
{
		...
		where TNode : TreeNode<TKey, TValue, TNode>
	{
		...
		#region Properties
		public TNode Parent { get => parent; internal set => parent = value; }
		public TNode Less { get => less; internal set => less = value; }
		public TNode More { get => more; internal set => more = value; }
